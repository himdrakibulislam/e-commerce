...
const Footer = () => {
    ...
    return (
<footer className="bg-gray-800 dark:bg-gray-800 border-t-2	border-sky-500">
    <div className="grid grid-cols-2 gap-8 px-6 py-8 md:grid-cols-3">
        <div>
            <h2 className="mb-6 text-sm font-semibold text-gray-500 uppercase dark:text-gray-400">{data?.shopInfo?.shop_name}</h2>
        ...
        <div>
            ...
            <ul className="text-gray-500 dark:text-gray-400">
                ...
                <li className="mt-4">
                    <Link to="https://www.linkedin.com/in/himdrakibulislam/" target="_blank" className="hover:underline">Developed by Rakibul Islam </Link>
                </li>
            </ul>
        </div>
        <div>
            <h2 className="mb-6 text-sm font-semibold text-gray-500 uppercase dark:text-gray-400">Contact us</h2>
            {
                data?.shopInfo ?  <div 
                
                dangerouslySetInnerHTML={{__html:data?.shopInfo?.shop_location}}>
    ...
    <div className="px-4 py-6 bg-gray-800 dark:bg-gray-800 md:flex md:items-center md:justify-between">
        <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2023 <a href="https://flowbite.com/">{data?.shopInfo?.shop_name}™</a>. All Rights Reserved.
        </span>
        <div className="flex mt-4 space-x-6 sm:justify-center md:mt-0">
            <Link to="https://m.facebook.com/ekantomart/"
            target="_blank"
